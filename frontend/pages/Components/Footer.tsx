            ...
            <Container>
                <Grid justify="space-around">
                    ...
                    <Grid.Col xs={12} sm={8} md={8} lg={8}>
                        ...
                        <Text size="xl" weight={500} color="white" mb="10px">Date de contact</Text>
                        <Text color="white">
                            E-mail: contact@autoflow.ro
                        </Text>
                        <Text color="white" mb="20px">
                            Phone: 0740 458 976
                        </Text>
                        
                        <Text size="xl" weight={500} color="white" mb="10px">CONTACTEAZĂ-NE!</Text>
                        ...
                        <Text color="white" mb="5px">
                            Theme Giuseppetm. © Copyright 2022 AutoFlow - Toate drepturile rezervate
                        </Text>
                    ...
                    <Grid.Col xs={12} sm={4} md={4} lg={4}>
                        ...
                        <Text size="xl" weight={500} color="white" mb="10px">Social media</Text>
